...
export function createAssetManager({ theme, ctx, clamp }) {
  ...
  function preloadThemeAssets() {
    const keys = [
      ...
      ...preloadHomeAssetsForTab("home"),
      ...preloadHomeAssetsForTab("more"),
      ...preloadHomeAssetsForTab("start"),
      ...preloadHomeAssetsForTab("journey"),
      ...preloadHomeAssetsForTab("materials"),
      ...preloadHomeAssetsForTab("quests"),
